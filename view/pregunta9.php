    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card question-card">
          <h3 class="text-center mb-4">Pregunta 9</h3>
          <p class="text-center mb-4">Vuelo sin alas, lloro sin ojos, siempre estoy en movimiento, pero no tengo pies. ¿Qué soy?</p>
          <img src="../public/img/dibujito.jpg">
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion1" value="opcion1">
            <label class="form-check-label" for="opcion1">Opción 1: Un río</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion2" value="opcion2">
            <label class="form-check-label" for="opcion2">Opción 2: Una sombra</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion3" value="opcion3">
            <label class="form-check-label" for="opcion3">Opción 3: El viento</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion4" value="opcion4">
            <label class="form-check-label" for="opcion4">Opción 4: Una nube</label>
          </div>
