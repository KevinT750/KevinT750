    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card question-card">
          <h3 class="text-center mb-4">Pregunta 7</h3>
          <p class="text-center mb-4">¿Qué flor es el símbolo más común del Día de San Valentín?</p>
          <img src="../public/img/roas.png">
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion1" value="opcion1">
            <label class="form-check-label" for="opcion1">Opción 1: Girasol</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion2" value="opcion2">
            <label class="form-check-label" for="opcion2">Opción 2: Margarita</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion3" value="opcion3">
            <label class="form-check-label" for="opcion3">Opción 3: Rosa</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion4" value="opcion4">
            <label class="form-check-label" for="opcion4">Opción 4: Tulipán</label>
          </div>
          ...
          if (selectedOption) {
            if (selectedOption.value === "opcion3") {
              ...
              Swal.fire({
                ...
                window.location.href = "pregunta8.php";
              });
            } else {
