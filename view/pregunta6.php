    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card question-card">
          <h3 class="text-center mb-4">Pregunta 6</h3>
          <p class="text-center mb-4">¿En qué siglo se popularizó el Día de San Valentín como una celebración romántica en Europa?</p>
          <img src="../public/img/siglo.jpg">
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion1" value="opcion1">
            <label class="form-check-label" for="opcion1">Opción 1: Siglo XIV</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion2" value="opcion2">
            <label class="form-check-label" for="opcion2">Opción 2: Siglo XVI</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion3" value="opcion3">
            <label class="form-check-label" for="opcion3">Opción 3: Siglo XVIII</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion4" value="opcion4">
            <label class="form-check-label" for="opcion4">Opción 4: Siglo XII</label>
          </div>
          ...
          if (selectedOption) {
            if (selectedOption.value === "opcion1") {
              ...
              Swal.fire({
                ...
                window.location.href = "pregunta7.php";
              });
            } else {
