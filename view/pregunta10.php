    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card question-card">
          <h3 class="text-center mb-4">Pregunta 10</h3>
          <p class="text-center mb-4">Cuanto más me quitas, más grande soy. ¿Qué soy?</p>
          <img src="../public/img/pregunta.jpg">
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion1" value="opcion1">
            <label class="form-check-label" for="opcion1">Opción 1: Un agujero</label>
          </div>
          <div class="form-check option">
          ...
          <div class="form-check option">
            ...
            <label class="form-check-label" for="opcion3">Opción 3: Un pozo</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion4" value="opcion4">
            <label class="form-check-label" for="opcion4">Opción 4: Un eco</label>
          </div>
