    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card question-card">
          <h3 class="text-center mb-4">Pregunta 8</h3>
          <p class="text-center mb-4">¿Cuál es el país donde más tarjetas de San Valentín se envían cada año?</p>
          <img src="../public/img/targeta.jpg">
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion1" value="opcion1">
            <label class="form-check-label" for="opcion1">Opción 1: Francia</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion2" value="opcion2">
            <label class="form-check-label" for="opcion2">Opción 2: Italia</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion3" value="opcion3">
            <label class="form-check-label" for="opcion3">Opción 3: España</label>
          </div>
          <div class="form-check option">
            <input class="form-check-input" type="radio" name="respuesta" id="opcion4" value="opcion4">
            <label class="form-check-label" for="opcion4">Opción 4: Estados Unidos</label>
          </div>
          ...
          if (selectedOption) {
            if (selectedOption.value === "opcion4") {
              ...
              Swal.fire({
                ...
                window.location.href = "pregunta9.php";
              });
            } else {
